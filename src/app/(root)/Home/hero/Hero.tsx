...
console.log(setGigSearch,setJobSearch)
  const handleSearch = () => {
    if (jobSearch.trim()) {
        ...
        <div className="flex flex-col items-center md:text-center">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <FadeUp>
              <p className="text-lg">Discover opportunities that match your skills and interests. Whether
              you&apos;re looking for a full-time job or freelance gigs.</p>
              </FadeUp>
            </div>
